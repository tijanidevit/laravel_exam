<div id="header" class="page-header">
        <div class="navbar navbar-expand-lg">
          <!-- brand -->
          <a href="index-2.html" class="navbar-brand d-lg-none"
            ><svg
              width="32"
              height="32"
              viewBox="0 0 512 512"
            ...
            <span class="hidden-folded d-inline l-s-n-1x d-lg-none">Muideen Aliu</span> </a
            ...
            <li class="nav-item dropdown">
              <a
                ...
                ><span class="avatar w-24" style="margin: -2px"
                  ><img src="assets/img/a4.jpg" alt="..." /></span
              ></a>
              <div
